...
<form method="post" action="<?php cheminpage("accueil"); ?>" name="connexion">
...
<p><div class="form-row justify-content-center">
    <div class="col-auto">
        <input type="password" name="code1" class="form-control input-lg mb-1 text-center border border-danger" maxlength="1" size="1" placeholder="c" id="code1" onKeyUp="suivant(this,'#code2', 1)" required>
    </div>
    <div class="col-auto">
        <input type="password" name="code2" class="form-control input-lg mb-1 text-center border border-danger" maxlength="1" size="1" placeholder="o" id="code2" onKeyUp="suivant(this,'#code3', 1)" required>
    </div>
    <div class="col-auto">
